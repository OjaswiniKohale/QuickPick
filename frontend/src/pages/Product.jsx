      ...
      <div className="row">
        <div className="col-md-3">
          <Cart
            price={30}
            name="Banana"
            img="https://tse4.mm.bing.net/th?id=OIP.IXKCpF-CG8jGSmOdUoYKIQHaEK&pid=Api&P=0&h=180"
            makeCart={makeCart}
        ...
        <div className="col-md-3">
          <Cart
            price={20}
            name="Grapes"
            img="https://tse1.mm.bing.net/th?id=OIP.S0MwlWV6Tgy2br4GfBaJcgHaE6&pid=Api&P=0&h=180"
            makeCart={makeCart}
            currentCart={currentCart}
          />
        </div>
        <div className="col-md-3">
          <Cart
            price={100}
            name="Apples"
            img="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcS1aXqHdPUhiGbV6IpAjNQWfago64IWwCZqlA&usqp=CAU"
            makeCart={makeCart}
            currentCart={currentCart}
          />
        </div>
        <div className="col-md-3">
          <Cart
            price={100}
            name="Oranges"
            img="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQcPhPFg7QhdbFjttG9SNME-uHndIPW2Y40Zw&usqp=CAU"
            makeCart={makeCart}
            currentCart={currentCart}
          />
        </div>
        <div className="col-md-3 mt-5">
          <Cart
            price={100}
            name="Pineapple"
            img="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRKNw11AtnkYWJNc3efgIMjnzsXPAB19qAP_w&usqp=CAU"
            makeCart={makeCart}
            currentCart={currentCart}
          />
        </div>
        <div className="col-md-3 mt-5">
          <Cart
            price={100}
            name="Guava"
            img="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcR2dQwLWdyqVnvijep83uzmRoX-FGXO_9SUcw&usqp=CAU"
            makeCart={makeCart}
            currentCart={currentCart}
          />
        </div>
        <div className="col-md-3 mt-5">
          <Cart
            price={100}
            name="Mangoes"
            img="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTfXdJPRyEebLRiUikB5x9hw-AwOYdNLUaKeA&usqp=CAU"
            makeCart={makeCart}
            currentCart={currentCart}
          />
        </div>
        <div className="col-md-3 mt-5">
          <Cart
            price={100}
            name="Strawberries"
            img="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcS8Q4uIH9CEAuEL80813qdvOdWUGUzbpbYMxQ&usqp=CAU"
            makeCart={makeCart}
            currentCart={currentCart}
          />
        </div>
